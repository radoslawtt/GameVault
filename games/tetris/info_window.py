...
class StartWindow:
    ...
    def __init__(self, game_window):
        ...
        self.about_game = pg.Rect(WINDOW_WIDTH*0.4, WINDOW_HEIGHT*0.4, TILE_SIZE*5, TILE_SIZE*2)
    ...
    def draw(self):
        ...
        pg.draw.rect(self.game_window.screen, "black", self.play_again, 3)
        self.game_window.screen.blit(text, text_rect)

        text = pg.font.SysFont("Arial", 30).render("Quick info", True, "black")
        text_rect = text.get_rect(center=(self.about_game.x + TILE_SIZE * 2.5, self.about_game.y + TILE_SIZE))
        pg.draw.rect(self.game_window.screen, (227, 239, 255), self.about_game)
        pg.draw.rect(self.game_window.screen, "black", self.about_game, 3)
        self.game_window.screen.blit(text, text_rect)
...
class AboutGame:
    ...
    def __init__(self, main_window):
        ...
        self.info = INFO
        self.back_button = pg.Rect(WINDOW_WIDTH * 0.4, WINDOW_HEIGHT * 0.5, TILE_SIZE * 5, TILE_SIZE * 2)

    def draw(self):
        for line in INFO:
            text = pg.font.SysFont("Arial", 25).render(line, True, "black")
            text_rect = text.get_rect(center=(WINDOW_WIDTH*0.5 , WINDOW_HEIGHT*0.1 + TILE_SIZE*INFO.index(line)))
            self.main_window.screen.blit(text, text_rect)

        text_1 = pg.font.SysFont("Arial", 30).render("Back", True, "black")
        text_rect = text_1.get_rect(center=(self.back_button.x + TILE_SIZE * 2.5, self.back_button.y + TILE_SIZE))
        ...
        self.main_window.screen.blit(text_1, text_rect)