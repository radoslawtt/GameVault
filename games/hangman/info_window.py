...
class StartWindow:
    ...
    def __init__(self, game_window):
        ...
        self.about_game = pg.Rect(WINDOW_WIDTH*0.4, WINDOW_HEIGHT*0.4, TILE_SIZE*6, TILE_SIZE*2)
    ...
    def draw(self):
        ...
        text = pg.font.SysFont("Arial", 30).render("About game", True, "black")
        text_rect = text.get_rect(center=(self.about_game.x + TILE_SIZE * 3, self.about_game.y + TILE_SIZE))
...
class AboutGame:
    ...
    def __init__(self, main_window):
        ...
        self.info = INFO
        self.back_button = pg.Rect(WINDOW_WIDTH * 0.4, WINDOW_HEIGHT * 0.25, TILE_SIZE * 5, TILE_SIZE * 2)

    def draw(self):

        for line in INFO:
            text = pg.font.SysFont("Arial", 25).render(line, True, "black")
            text_rect = text.get_rect(center=(WINDOW_WIDTH * 0.5, WINDOW_HEIGHT * 0.05 + TILE_SIZE * INFO.index(line)))
